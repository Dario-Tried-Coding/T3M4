...
export type ConfigValidationErrorCode =
  ...
  | "CONFIG_FACETS_UNKNOWN" // config ha facets ma schema no
  ...
  | "CONFIG_FACET_UNKNOWN" // facet presente in config, assente in schema
  ...
  | "CONFIG_MODE_STRING_DEFAULT_NOT_EQUAL_SCHEMA" // default != schema.mode (string)
  ...
  | "CONFIG_MODE_ARRAY_DEFAULT_INVALID_TYPE"
  ...
  | "CONFIG_MODE_ARRAY_COLOR_SCHEMES_UNKNOWN_KEY" // chiave extra non presente in schema.mode[]
  ...
  | "CONFIG_MODE_OBJECT_DEFAULT_INVALID_TYPE"
  ...
  | "CONFIG_MODE_OBJECT_FALLBACK_INVALID_TYPE"
  ...
  | "CONFIG_MODE_OBJECT_COLOR_SCHEMES_UNKNOWN_KEY" // chiave extra non in custom[*]
